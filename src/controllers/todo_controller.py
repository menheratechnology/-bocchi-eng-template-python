...
def find_all():
    ...
    todos = todo_repository.fetch_all() # TODO: todo_repositoryのfetch_allメソッドから受け取ったtodosを代入する
...
def create(req: CreateTodoRequest):
    ...
    todos = todo_repository.create(req.name,req.is_done) # TODO: todo_repositoryのcreateメソッドから受け取った新しいtodosを代入する
    return JSONResponse(content={
        'status': 200,
